	...
	<body>
		...
		<div id="show-application" class="content scaffold-show" role="main">
			...
			<ol class="property-list application">
				...
				<g:if test="${applicationInstance?.placements}">
				<li class="fieldcontain">
					<span id="placements-label" class="property-label"><g:message code="application.placements.label" default="Placements" /></span>
					
						<span class="property-value" aria-labelledby="placements-label"><g:link controller="placements" action="show" id="${applicationInstance?.placements?.id}">${applicationInstance?.placements?.encodeAsHTML()}</g:link></span>
