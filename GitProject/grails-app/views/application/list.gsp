			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="application.placements.label" default="Placements" /></th>
				...
				<g:each in="${applicationInstanceList}" status="i" var="applicationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${applicationInstance.id}">${fieldValue(bean: applicationInstance, field: "placements")}</g:link></td>
